...
const envSchema = z.object({
  ...
  DELIVERY_PROVIDER: z.enum(["mock", "wolt", "sandbox"]).default("sandbox"),
  GEOCODER_PROVIDER: z.enum(["google", "photon", "osm", "mock", "maptiler"]).optional(),
  ...
  WOLT_DRIVE_VENUE_ID: z.string().optional(),
  WOLT_DRIVE_API_KEY: z.string().optional(),
  WOLT_WEBHOOK_SECRET: z.string().optional(),
  FOODORA_API_BASE_URL: z.string().optional(),
  FOODORA_API_KEY: z.string().optional(),
  FOODORA_WEBHOOK_SECRET: z.string().optional(),
  ...
  PUBLIC_APP_HOST: z.string().optional(),
  ADMIN_APP_HOST: z.string().optional(),
  KITCHEN_APP_HOST: z.string().optional(),
  ADMIN_APP_BASE_URL: z.string().optional(),
  KITCHEN_APP_BASE_URL: z.string().optional(),
